...
def train():
    ...
    data_path = "/home1/devavara/EE599-Project/ml-systems-final-project-SamDJ101-main/200.json"
    ...
    print(f"Average loss: {(l/c):.7f}")
    max = torch.cuda.max_memory_allocated()
    print(f"Peak GPU memory usage: {max / 1024**2:.2f} MB")
    print(f"Computation: {(end-start):.2f} secs")
    
    save_path = "./Amp_GA.pth"
